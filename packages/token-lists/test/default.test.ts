...
import currentligerswapDefaultList from "../lists/ligerswap-default.json";
import currentligerswapExtendedtList from "../lists/ligerswap-extended.json";
import currentligerswapTop15List from "../lists/ligerswap-top-10.json";
import { buildList, VersionBump } from "../src/buildList";

const currentLists = {
  "ligerswap-default": currentligerswapDefaultList,
  "ligerswap-extended": currentligerswapExtendedtList,
  "ligerswap-top-10": currentligerswapTop15List,
};
...
expect.extend({
  ...
  toBeValidLogo(token) {
    ...
    const refersToLocalLogo = token.logoURI === `https://tokens.ligerswap.org/images/${token.address}.png`;
...
describe.each([["ligerswap-default"], ["ligerswap-extended"], ["ligerswap-top-10"]])(
  "buildList %s",
  (listName) => {
